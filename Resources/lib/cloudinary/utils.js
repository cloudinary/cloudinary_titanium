...
(function() {
  var build_array, cloudinary_url, config, crc32, generate_transformation_string, html_only_attributes, option_consume, present, utf8_encode;
  ...
  exports.generate_transformation_string = generate_transformation_string = function(options) {
    var angle, background, base_transformation, base_transformations, border, crop, dpr, effect, flags, has_layer, height, key, named_transformation, no_html_sizes, param, params, result, short, simple_params, size, transformation, value, width, _ref, _ref1, _ref2, _ref3;
